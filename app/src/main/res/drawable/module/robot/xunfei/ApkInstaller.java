package com.weiruanit.lifepro.module.robot.xunfei;
...
public class ApkInstaller {
    ...
    public void install() {
        ...
        builder.setNegativeButton("残忍拒绝", new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                SharedPreferences.Editor isRefuse = mActivity.getSharedPreferences("isrefuse",
                        Context.MODE_PRIVATE).edit();
                isRefuse.putBoolean("isRefuse",true);
                isRefuse.commit();
                dialog.dismiss();
            }
        });
