...
public class NewsListItemAdapter extends RecyclerView.Adapter<NewsListItemAdapter.BaseViewHolder> {


    private List<WorldNewsBean.NewslistBean> mNewslistBean = new ArrayList<>();
    private OnItemClickLitener mOnItemClickLitener;

    public NewsListItemAdapter(List<WorldNewsBean.NewslistBean> mNewslistBean) {
    ...
    public void onBindViewHolder(final BaseViewHolder holder, int position) {
        ...
        WorldNewsBean.NewslistBean newslistBean = mNewslistBean.get(position);
